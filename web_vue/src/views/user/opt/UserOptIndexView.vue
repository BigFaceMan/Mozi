...
const fetchUsers = () => {
    $.ajax({
        url: "http://10.129.79.55:3000/user/getlist/",
        type: "get",
        headers: {
...
const addUser = () => {
    ...
    $.ajax({
        url: "http://10.129.79.55:3000/user/addbyname/",
        type: "post",
        headers: {
            Authorization: "Bearer " + store.state.user.token,
        },
...
const updateUser = () => {
    ...
    $.ajax({
        url: "http://10.129.79.55:3000/user/updatabyname/",
        type: "post",
        headers: {
            Authorization: "Bearer " + store.state.user.token,
        },
...
const deleteUser = (user_id) => {
    if (confirm('确定要删除这个用户吗？')) {
        ...
        $.ajax({
            url: "http://10.129.79.55:3000/user/deletebyid/",
            type: "post",
            headers: {
                Authorization: "Bearer " + store.state.user.token,
            },
...
const approveTraining = (training) => {
    ...
    $.ajax({
        url: "http://10.129.79.55:3000/user/ansAsk/",
        type: "post",
        headers: {
            Authorization: "Bearer " + store.state.user.token,
        },
